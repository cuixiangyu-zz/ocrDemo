...
@EnableScheduling
@MapperScan("com.cxy.ocrDemo.dao")
public class OcrDemoApplication extends WebMvcConfigurerAdapter {

    public static void main(String[] args) {
        System.setProperty("org.apache.tomcat.util.buf.UDecoder.ALLOW_ENCODED_SLASH", "true");
        ApplicationContext context = SpringApplication.run(OcrDemoApplication.class, args);
